...
import se.peter.ivarsson.whitelist.check.CheckUnicodeValidator;
...
@Retention(RUNTIME)
@Constraint(validatedBy = CheckUnicodeValidator.class)
public @interface Unicode {

    String message() default "Please enter only Unicode charaters and whitespace.";
